...
public class EstimateDetailService {
    ...
    public StructureDetail showEstimateDetailId(Long id) {
        return (StructureDetail)this.estimateDetailRepository.findOne(id);
    }
    ...
    public StructureDetail saveEstimateDetailEtc(StructureDetail insertEstimateDetail) {
        ...
        return (StructureDetail)this.estimateDetailRepository.findOne(insertEstimateDetail.getId());
    }

    public void deleteInsideWall(Long id) {
        this.estimateInsideWallRepository.delete(id);
    }

    public void deleteCeiling(Long id) {
        this.estimateCeilingRepository.delete(id);
    }

    public void deleteWindow(Long id) {
        this.estimateWindowRepository.delete(id);
    }

    public void deleteDoor(Long id) {
        this.estimateDoorRepository.delete(id);
    }

    public void deleteCanopy(Long id) {
        this.estimateCanopyRepository.delete(id);
    }
